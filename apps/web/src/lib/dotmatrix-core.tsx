// Vendored from dot-matrix (https://github.com/zzzzshawn/matrix).
// Copyright (c) 2026 dot-matrix contributors. All rights reserved.
// Used internally within Synara per the dot-matrix proprietary license.
"use client";
