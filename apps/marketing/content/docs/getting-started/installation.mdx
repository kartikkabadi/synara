...
Download the latest stable build from the [Synara download page](/install). If the automatic download is unavailable, open [GitHub Releases](https://github.com/kartikkabadi/synara/releases) and select the asset for your system.
