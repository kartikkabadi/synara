...
1. Search existing [Synara issues](https://github.com/kartikkabadi/synara/issues).
...
Open a new report in [Synara issues](https://github.com/kartikkabadi/synara/issues/new) only after this checklist is complete.
