    ...
    execute: (row) =>
      sql`
        ...
        DO UPDATE SET
          ...
          goal_paused_reason = excluded.goal_paused_reason,
          goal_token_budget = excluded.goal_token_budget,
          goal_tokens_used = excluded.goal_tokens_used,
          goal_tokens_observed_json = excluded.goal_tokens_observed_json,
          goal_budget_limited_at = excluded.goal_budget_limited_at,
