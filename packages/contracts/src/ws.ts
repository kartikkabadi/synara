...
export const WS_METHODS = {
  ...
  serverGetGlobalInstructions: "server.getGlobalInstructions",
  serverUpdateGlobalInstructions: "server.updateGlobalInstructions",
...
const WebSocketRequestBody = Schema.Union([
  ...
  tagRequestBody(WS_METHODS.serverGetGlobalInstructions, Schema.Struct({})),
  tagRequestBody(WS_METHODS.serverUpdateGlobalInstructions, ServerUpdateGlobalInstructionsInput),
